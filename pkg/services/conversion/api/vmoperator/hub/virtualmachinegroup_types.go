...
var _ conversion.Hub = &VirtualMachineGroup{}

// SetSourceAPIVersion set the API version this object is converted from.
func (vmg *VirtualMachineGroup) SetSourceAPIVersion(v string) {
	vmg.Source.APIVersion = v
}

// GetSourceAPIVersion grt the API version this object is converted from.
func (vmg *VirtualMachineGroup) GetSourceAPIVersion() string {
	return vmg.Source.APIVersion
}
