...
var _ conversion.Hub = &VirtualMachineImage{}

// SetSourceAPIVersion set the API version this object is converted from.
func (i *VirtualMachineImage) SetSourceAPIVersion(v string) {
	i.Source.APIVersion = v
}

// GetSourceAPIVersion grt the API version this object is converted from.
func (i *VirtualMachineImage) GetSourceAPIVersion() string {
	return i.Source.APIVersion
}
