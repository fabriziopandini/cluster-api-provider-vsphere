...
var _ vmoprconversion.Hub = &VirtualMachineImage{}

func (s *VirtualMachineImage) Hub() {}

func (s *VirtualMachineImage) SetConvertibleAPIVersion(v string) {
	s.Convertible.APIVersion = v
}

func (s *VirtualMachineImage) GetConvertibleAPIVersion() string {
