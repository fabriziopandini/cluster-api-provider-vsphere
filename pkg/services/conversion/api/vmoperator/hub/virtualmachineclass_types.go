...
func (c *VirtualMachineClass) SetSourceAPIVersion(v string) {
	c.Source.APIVersion = v
}

// GetSourceAPIVersion grt the API version this object is converted from.
func (c *VirtualMachineClass) GetSourceAPIVersion() string {
	return c.Source.APIVersion
}
