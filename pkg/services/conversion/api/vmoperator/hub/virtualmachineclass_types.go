...
func (c *VirtualMachineClass) Hub() {}

func (c *VirtualMachineClass) SetConvertibleAPIVersion(v string) {
	c.Convertible.APIVersion = v
}

func (c *VirtualMachineClass) GetConvertibleAPIVersion() string {
	return c.Convertible.APIVersion
}
