...
func (c *VirtualMachineServiceConvertibleWrapper) ConvertToHub(srcRaw runtime.Object, dstRaw runtime.Object) error {
	src, ok := srcRaw.(*vmoprv1alpha2.VirtualMachineService)
	if !ok {
		return errors.Errorf("src object must be of type %T, got %T", &vmoprv1alpha2.VirtualMachineService{}, srcRaw)
	}
...
func (c *VirtualMachineServiceConvertibleWrapper) ConvertFromHub(srcRaw runtime.Object, dstRaw runtime.Object) error {
	...
	dst, ok := dstRaw.(*vmoprv1alpha2.VirtualMachineService)
	if !ok {
		return errors.Errorf("dst object must be of type %T, got %T", &vmoprv1alpha2.VirtualMachineService{}, dstRaw)
	}
