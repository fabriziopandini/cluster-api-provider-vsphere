...
func (c *VirtualMachineGroupConvertibleWrapper) SpokeGroupVersionKind() schema.GroupVersionKind {
	return vmoprv1alpha2.GroupVersion.WithKind("VirtualMachineGroup")
}

func (c *VirtualMachineGroupConvertibleWrapper) ConvertToHub(srcRaw runtime.Object, dstRaw runtime.Object) error {
	src, ok := srcRaw.(*vmoprv1alpha2.VirtualMachineGroup)
	if !ok {
		return errors.Errorf("src object must be of type %T, got %T", &vmoprv1alpha2.VirtualMachineGroup{}, srcRaw)
	}
...
func (c *VirtualMachineGroupConvertibleWrapper) ConvertFromHub(srcRaw runtime.Object, dstRaw runtime.Object) error {
	...
	dst, ok := dstRaw.(*vmoprv1alpha2.VirtualMachineGroup)
	if !ok {
		return errors.Errorf("dst object must be of type %T, got %T", &vmoprv1alpha2.VirtualMachineGroup{}, dstRaw)
	}
