...
replace sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.12.0-rc.1

replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.12.0-rc.1

replace sigs.k8s.io/cluster-api-provider-vsphere => ../

// FIXME: check this (why we need to import a specific commit of testlabels)
...
// FIXME: check this (why we need a replace)
replace github.com/vmware-tanzu/vm-operator/api => github.com/vmware-tanzu/vm-operator/api v1.9.1-0.20250908141901-a9e1dfbc0045
